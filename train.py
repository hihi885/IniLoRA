...
class TrainingArguments(transformers.TrainingArguments):
    ...
    qlora: bool = field(default=False, metadata={"help": ""})
...
def train():
    ...
    if script_args.init_lora_weights != 'fp':
        ...
        if script_args.gradient_checkpointing:
            print('is using gradient_checkpointing')
            model.enable_input_require_grads()  # transformers==4.43.4
